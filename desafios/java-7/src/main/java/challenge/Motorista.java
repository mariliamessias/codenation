...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        private void validaNome(String nome){
            if( nome.isEmpty() || nome == null) throw new NullPointerException("Nome não informado.");
        }

        private void validaHabilitacao(String habilitacao){
            if( habilitacao.isEmpty() || habilitacao == null) throw new NullPointerException("Habilitação não informada.");
        }
